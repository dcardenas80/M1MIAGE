...
public class RecordableCopyText extends CopyText implements RecordCommand {
	...
	public void execute() {
		...
		beforeContent = editorMotorImpl.getContentClipboard();
		super.execute();
	...
	public Memento getMemento() {
		// TODO Auto-generated method stub
		editorMotorImpl = EditorMotorImpl.getInstance();
		afterContent = editorMotorImpl.getContentClipboard();
		copyTextMemento = new CopyTextMemento(afterContent,beforeContent);
	...
	public void reverseCommand(Memento memento) {
		// TODO Auto-generated method stub
		String content = ((CopyTextMemento)memento).getStateBefore();
		editorMotorImpl = EditorMotorImpl.getInstance();
		editorMotorImpl.setContentClipboard(content);
		recorder = Recorder.getInstance();
	}
